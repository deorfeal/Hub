...
if (document.querySelector("[data-sphere-scene]")) {
  (function () {
    ...
    function getSceneScale() {
      return container.clientWidth <= 1440 ? 0.75 : 1;
    }
    ...
    function updateTileVisual(tile, time) {
      ...
      const scale =
        ...
        (container.clientWidth < 900 ? 0.82 : container.clientWidth < 1440 ? 0.9 : 1) *
    ...
    function updateCallout() {
      const target = interaction.selected || interaction.hovered;
